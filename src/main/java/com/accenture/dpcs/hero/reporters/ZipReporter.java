package com.accenture.dpcs.hero.reporters;
...
public class ZipReporter implements IReporter {
    ...
    public void zip4j(String outputDirectory, String zipFinalName) {
        ...
        try {
            ...
            HeroErrorUtils.log("ZipReporter-> generateReport:: Exception: " + outputDirectory, e);
        }
    }
    ...
    public void zip(String outputDirectory, String zipFinalName) {
        ...
        try {
            ...
            HeroErrorUtils.log("ZipReporter-> generateReport:: FileNotFoundException: " + outputDirectory, e);
        } catch (IOException e) {
            HeroErrorUtils.log("ZipReporter-> generateReport:: IOException: " + outputDirectory, e);
        }
    }
