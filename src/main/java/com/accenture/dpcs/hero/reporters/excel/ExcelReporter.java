package com.accenture.dpcs.hero.reporters.excel;
...
public class ExcelReporter implements IReporter {
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
        String templatePath = HeroConfigWrapper.INSTANCE.get("excel.report.template", "/reports/HeroReportTemplate.xlsx");
    ...
    protected void processDashboardSheet(XSSFSheet sheet) {
        ...
        if (titleCell != null) {
            titleCell.setCellValue(HeroConfigWrapper.INSTANCE.get("excel.report.title", "Hero Suite Report"));
        }
    ...
    protected void processResultsSheetRow(XSSFSheet sheet, ISuite suite, ITestResult result, String status, int rowIndex) {
        ...
        setCellValue(row, 1, HeroReportUtils.getClassTitle(result));
        setCellValue(row, 2, HeroReportUtils.getMethodTitle(result, false, true));
        setCellValue(row, 3, HeroReportUtils.getMethodParametersAsString(result, true));
        setCellValue(row, 4, HeroReportUtils.getBrowser(result));
